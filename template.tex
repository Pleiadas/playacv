...
%%% Add the "normalphoto" option if you want a square image in the header instead of cropped to a circle 
% \documentclass[10pt,a4paper,withhyper,normalphoto,ragged2e]{playacv} % also options, e.g. withhyper for hidden urls
...
\begin{document}
	...
	%%% change chapter ordering for this application, you can always include or exclude them later with \WithChapter
	...
	]{\OnlyCoverLetter}{} % exclude cv if only letter to be printed
	%
